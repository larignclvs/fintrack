...
def test_category_not_found_and_update_delete_errors(client):
    ...
    # update should map not-found to 400
...
def test_transaction_not_found_update_delete(client):
    ...
    # update (not found -> 400)
    # send a minimal valid update body so request validation passes and the
    # service gets invoked (and should map not-found to 400)
    payload = {"amount": 10.0}
